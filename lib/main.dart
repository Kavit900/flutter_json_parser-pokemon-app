  ...
  Future<void> readJson() async {
    ...
    setState(() {
      pokemonList = data['pokemons']
          .map((data) => Pokemon.fromJson(data)).toList();
    });
  }
            ...
            children: [
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Column(
                            ...
                            children: [
                              Text(pokemon.name, style: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.w500)),
                              SizedBox(height: 5,),
                              Text(pokemon.category, style: TextStyle(color: Colors.grey[500])),
                            ]
                        ),
                      )
                    ]
              ...
              GestureDetector(
                ...
                child: AnimatedContainer(
                    ...
                    child: Center(
                        child: pokemon.isMyFav ? Icon(Icons.favorite, color: Colors.red,) : Icon(Icons.favorite_outline, color: Colors.grey.shade600)
                    )
                ),
              )
            ],
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Text(pokemon.category, style: TextStyle(color: Colors.black),),
                    ),
                    SizedBox(width: 10,),
                    Container(
                      padding: EdgeInsets.symmetric(vertical: 8, horizontal: 15),
